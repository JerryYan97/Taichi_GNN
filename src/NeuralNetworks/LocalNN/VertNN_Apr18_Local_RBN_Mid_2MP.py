...
# Local vertex NN
class VertNN_Apr18_LocalLinear_RBN_Mid_2MP(nn.Module):
    def __init__(self, nfeat, fc_out, dropout, device):
        super(VertNN_Apr18_LocalLinear_RBN_Mid_2MP, self).__init__()
