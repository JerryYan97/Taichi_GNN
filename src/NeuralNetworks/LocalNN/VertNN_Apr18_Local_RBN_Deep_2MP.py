...
# Local vertex NN
class VertNN_Apr18_LocalLinear_RBN_Deep_2MP(nn.Module):
    def __init__(self, nfeat, fc_out, dropout, device):
        super(VertNN_Apr18_LocalLinear_RBN_Deep_2MP, self).__init__()
        ...
        self.fc11 = nn.Linear(960, 800)
        self.fc12 = nn.Linear(800, 640)
        self.bn4 = nn.BatchNorm1d(num_features=640)

        self.fc13 = nn.Linear(640, 512)
        self.fc14 = nn.Linear(512, 256)
        ...
        self.fc20 = nn.Linear(8, 3)
        self.fc21 = nn.Linear(3, 3)
        self.ELU = nn.ELU()
