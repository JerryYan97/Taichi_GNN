...
class VertNN_Mar3_LocalLinear(nn.Module):
    def __init__(self, nfeat, fc_out, dropout, device):
        ...
        self.bn1 = nn.BatchNorm1d(num_features=480)
        ...
        self.bn3 = nn.BatchNorm1d(num_features=156)
        ...
        self.bn5 = nn.BatchNorm1d(num_features=110)

        self.fc11 = nn.Linear(110, 100)
        self.fc12 = nn.Linear(100, 96)
        self.bn6 = nn.BatchNorm1d(num_features=96)

        self.fc13 = nn.Linear(96, 128)
        self.fc14 = nn.Linear(128, 72)
        self.bn7 = nn.BatchNorm1d(num_features=72)
        self.fc15 = nn.Linear(72, 56)
        self.fc16 = nn.Linear(56, 48)
        self.bn8 = nn.BatchNorm1d(num_features=48)
    ...
    def forward(self, x):
        ...
        y = self.ELU(self.bn7(self.fc14(y)))
        y = self.ELU(self.fc15(y))
        y = self.ELU(self.bn8(self.fc16(y)))
