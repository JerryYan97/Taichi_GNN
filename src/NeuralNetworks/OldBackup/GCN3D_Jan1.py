...
class GCN3D_Jan1(nn.Module):
    def __init__(self, graph_node_num, cluster_num,
                 nfeat, gcn_hid1, gcn_hid2, gcn_hid3,
                 gcn_out1, gcn_out2,
                 fc_hid, fc_out):
        super(GCN3D_Jan1, self).__init__()
        self.GCN1 = GCNConv(nfeat, gcn_hid1)
        self.GCN6 = GCNConv(gcn_hid1, gcn_hid2)
        self.GCN2 = GCNConv(gcn_hid2, gcn_hid3)
        self.GCN3 = GCNConv(gcn_hid3, gcn_out1)

        # self.bn = BatchNorm(gcn_out1)
        self.istn = InstanceNorm(gcn_out1)
        self.fc_Temp1 = nn.Linear(gcn_out1, 32)
        self.fc_Temp2 = nn.Linear(32, 64)
        self.GCN4 = GCNConv(64, gcn_hid3)
        self.GCN5 = GCNConv(gcn_hid3, gcn_hid2)
        self.GCN7 = GCNConv(gcn_hid2, gcn_out2)
