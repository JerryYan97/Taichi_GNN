...
class GCN3D_Feb13_MoreLinears(nn.Module):
    def __init__(self, graph_node_num, cluster_num,
        ...
        self.GCN3 = GCNConv(128, 96)
        self.fc_tmp1 = nn.Linear(96, 96)
        self.fc3 = nn.Linear(96, 64)
        self.fc_tmp2 = nn.Linear(64, 64)

        self.GCN4 = GCNConv(64, 32)
        self.fc4 = nn.Linear(32, 32)
        self.fc_tmp3 = nn.Linear(32, 24)
        self.fc_tmp4 = nn.Linear(24, 24)

        self.GCN5 = GCNConv(24, 16)
        self.fc_tmp5 = nn.Linear(16, 16)
        self.fc_tmp6 = nn.Linear(16, 4)
        self.fc_tmp7 = nn.Linear(4, 3)
    ...
    def forward(self, x, adj, num_graphs, in_batch, cluster):
        ...
        z = self.ELU(self.fc_tmp1(z))
        z = self.ELU(self.fc3(z))
        z = self.ELU(self.fc_tmp2(z))
        z = self.ELU(self.GCN4(z, adj))
        z = self.ELU(self.fc4(z))
        z = self.ELU(self.fc_tmp3(z))
        z = self.ELU(self.fc_tmp4(z))
        z = self.ELU(self.GCN5(z, adj))
        z = self.ELU(self.fc_tmp5(z))
        z = self.ELU(self.fc_tmp6(z))
        z = self.ELU(self.fc_tmp7(z))
        z = self.fc5(z)
        return z
