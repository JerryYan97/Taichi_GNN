    ...
    for e in range(n_elements):
        ...
        if ti.static(dim == 2):
            ...
            for colI in ti.static(range(9)):
                ...
                # intermediate[3, colI] = 0
                # intermediate[4, colI] = 0
                # intermediate[5, colI] = 0
                # intermediate[6, colI] = 0
                # intermediate[7, colI] = 0
                # intermediate[8, colI] = 0
                # intermediate[9, colI] = 0
                # intermediate[10, colI] = 0
                # intermediate[11, colI] = 0
...
#                 intermediate[10, colI] = 0
#                 intermediate[11, colI] = 0
#                 intermediate[0, colI] = 0
#                 intermediate[1, colI] = 0
#                 intermediate[2, colI] = 0
#
#                 # intermediate[3, colI] = IB[0, 0] * dPdF[0, colI] + IB[0, 1] * dPdF[3, colI] + IB[0, 2] * dPdF[6, colI]
#                 # intermediate[4, colI] = IB[0, 0] * dPdF[1, colI] + IB[0, 1] * dPdF[4, colI] + IB[0, 2] * dPdF[7, colI]
#                 # intermediate[5, colI] = IB[0, 0] * dPdF[2, colI] + IB[0, 1] * dPdF[5, colI] + IB[0, 2] * dPdF[8, colI]
...
#             for rowI in ti.static(range(12)):
#                 c = cnt[None] + e * 144 + rowI * 12 + 0
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[3], IB[0, 0] * intermediate[
#                     rowI, 0] + IB[0, 1] * intermediate[rowI, 3] + IB[0, 2] * intermediate[rowI, 6]
#                 c = cnt[None] + e * 144 + rowI * 12 + 1
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[4], IB[0, 0] * intermediate[
#                     rowI, 1] + IB[0, 1] * intermediate[rowI, 4] + IB[0, 2] * intermediate[rowI, 7]
#                 c = cnt[None] + e * 144 + rowI * 12 + 2
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[5], IB[0, 0] * intermediate[
#                     rowI, 2] + IB[0, 1] * intermediate[rowI, 5] + IB[0, 2] * intermediate[rowI, 8]
#                 c = cnt[None] + e * 144 + rowI * 12 + 3
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[6], IB[1, 0] * intermediate[
#                     rowI, 0] + IB[1, 1] * intermediate[rowI, 3] + IB[1, 2] * intermediate[rowI, 6]
#                 c = cnt[None] + e * 144 + rowI * 12 + 4
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[7], IB[1, 0] * intermediate[
#                     rowI, 1] + IB[1, 1] * intermediate[rowI, 4] + IB[1, 2] * intermediate[rowI, 7]
#                 c = cnt[None] + e * 144 + rowI * 12 + 5
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[8], IB[1, 0] * intermediate[
#                     rowI, 2] + IB[1, 1] * intermediate[rowI, 5] + IB[1, 2] * intermediate[rowI, 8]
#                 c = cnt[None] + e * 144 + rowI * 12 + 6
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[9], IB[2, 0] * intermediate[
#                     rowI, 0] + IB[2, 1] * intermediate[rowI, 3] + IB[2, 2] * intermediate[rowI, 6]
#                 c = cnt[None] + e * 144 + rowI * 12 + 7
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[10], IB[2, 0] * intermediate[
#                     rowI, 1] + IB[2, 1] * intermediate[rowI, 4] + IB[2, 2] * intermediate[rowI, 7]
#                 c = cnt[None] + e * 144 + rowI * 12 + 8
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[11], IB[2, 0] * intermediate[
#                     rowI, 2] + IB[2, 1] * intermediate[rowI, 5] + IB[2, 2] * intermediate[rowI, 8]
#                 c = cnt[None] + e * 144 + rowI * 12 + 9
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[0], -data_mat[2, c - 9] - \
#                                                                  data_mat[2, c - 6] - data_mat[2, c - 3]
#                 c = cnt[None] + e * 144 + rowI * 12 + 10
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[1], -data_mat[2, c - 9] - \
#                                                                  data_mat[2, c - 6] - data_mat[2, c - 3]
#                 c = cnt[None] + e * 144 + rowI * 12 + 11
#                 data_mat[0, c], data_mat[1, c], data_mat[2, c] = indMap[rowI], indMap[2], -data_mat[2, c - 9] - \
#                                                                  data_mat[2, c - 6] - data_mat[2, c - 3]
#             R10 = IB[0, 0] * P[0, 0] + IB[0, 1] * P[0, 1] + IB[0, 2] * P[0, 2]
#             R11 = IB[0, 0] * P[1, 0] + IB[0, 1] * P[1, 1] + IB[0, 2] * P[1, 2]
#             R12 = IB[0, 0] * P[2, 0] + IB[0, 1] * P[2, 1] + IB[0, 2] * P[2, 2]
...
def compute_energy() -> real:
    ...
    for e in range(n_elements):
        ...
        if dim == 3:
            total_energy += fixed_corotated_energy(ti.Vector([sig[0, 0], sig[1, 1], sig[2, 2]]), la, mu) * dt * dt * vol0
        else:
...
def set_exforce():
    ...
    z = exf_mag * ti.sin(3.1415926 / 180.0 / 2.0 * exf_angle)
...
if __name__ == "__main__":
    ...
    for f in range(1, 500):
        ...
        while True:
            ...
            data_sol.from_numpy(solve_linear_system(data_mat.to_numpy(), data_rhs.to_numpy(), n_particles * 2, dirichlet,
